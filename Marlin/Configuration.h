...
#define STRING_CONFIG_H_AUTHOR "(1activegeek, Ender-3)" // Who made the changes.
 ...
 */
// #define BAUDRATE 115200 // -- left from 2.0.8.2 merge
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  36.29   // Results from PID Autotune 2021-02-21
    #define DEFAULT_Ki   4.67   // Results from PID Autotune 2021-02-21
    #define DEFAULT_Kd  70.56   // Results from PID Autotune 2021-02-21
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 65.16   // Results from PID Autotune 2021-02-21
  #define DEFAULT_bedKi 11.78   // Results from PID Autotune 2021-02-21
  #define DEFAULT_bedKd 240.35  // Results from PID Autotune 2021-02-21
...
// #define E0_DRIVER_TYPE A4988  // -- commented out on 2.0.8 merge
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 92.8 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.5, -8.2, -0.93 }
